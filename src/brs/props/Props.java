...
public class Props {
  ...
  public static final Prop<Integer> P2P_PORT        = new Prop<>("P2P.Port", 8323);
  ...
  public static final Prop<Integer> API_PORT    = new Prop<>("API.Port", 8325);
  public static final Prop<String> API_V2_LISTEN  = new Prop<>("API.V2.Listen", "0.0.0.0");
  public static final Prop<Integer> API_V2_PORT    = new Prop<>("API.V2.Port", 8321);
